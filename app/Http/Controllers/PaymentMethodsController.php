...
class PaymentMethodsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $inscriptions = $method->inscriptions()->orderBy('updated_at', 'desc')->paginate(15, ['*'], 'inscriptions');
        $payments = $method->payments()->orderBy('updated_at', 'desc')->paginate(15, ['*'], 'payments');
        ...
        return view('backend.settings.method.show', compact('method', 'sales', 'inscriptions', 'payments', 'cards', 'cardsincome', 'cardsexpense'));
    }
