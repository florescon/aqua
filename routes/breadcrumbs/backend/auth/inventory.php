...
Breadcrumbs::for('admin.inventory.product.index', function ($trail) {
    $trail->parent('admin.dashboard');
    $trail->push(__('labels.backend.access.product.management'), route('admin.inventory.product.index'));
});


Breadcrumbs::for('admin.inventory.product.show', function ($trail, $id) {
    $trail->parent('admin.inventory.product.index');
    $trail->push(__('labels.backend.access.product.view'), route('admin.inventory.product.show', $id));
});
